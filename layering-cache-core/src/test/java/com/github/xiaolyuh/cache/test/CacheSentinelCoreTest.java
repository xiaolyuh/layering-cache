...
import com.github.xiaolyuh.cache.config.CacheSentinelConfig;
...
public class CacheSentinelCoreTest {
    private Logger logger = LoggerFactory.getLogger(CacheSentinelCoreTest.class);
