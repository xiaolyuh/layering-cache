...
import com.github.xiaolyuh.cache.config.CacheSingleConfig;
...
public class CacheSingleCoreTest {
    private Logger logger = LoggerFactory.getLogger(CacheSingleCoreTest.class);
